...
import 'widget/restaurant_view.dart';
import 'widget/restaurants_view.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Future<void> _loadData(BuildContext context, bool reload) async {
    if(Provider.of<AuthProvider>(context, listen: false).isLoggedIn()) {
      ...
      await Provider.of<OrderProvider>(context, listen: false).getOrdersList(context);
    }
    ...
    await Provider.of<RestaurantsProvider>(context, listen: false).getRestaurantList(context, reload);
                  ...
                  title: Consumer<SplashProvider>(builder:(context, splash, child) => Row(
                    ...
                    children: [
                      ResponsiveHelper.isWeb() ? FadeInImage.assetNetwork(
                        ...
                        height: 40, width: 40,
                      ) : Image.asset(Images.logo, height: 18),/*
                      SizedBox(width: 10),
                      Text(
                      ...
                      */
                      ...
                      Consumer<RestaurantsProvider>(
                        builder: (context, restaurant, child) {
                          restaurant.restaurantsList == null ?print(''):
                          print(restaurant.restaurantsList.length.toString()+' --------------');
                          return restaurant.restaurantsList == null ? RestaurantsView() : restaurant.restaurantsList.length == 0 ? SizedBox() : RestaurantsView();
                        },
                      ),
