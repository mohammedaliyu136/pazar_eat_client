  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<RestaurantsProvider>(
      builder: (context, restaurant, child) {
        print('---------==========');
        print(restaurant.restaurantsList);
        return Column(
          children: [
           Padding(
              padding: EdgeInsets.fromLTRB(10, 20, 10, 10),//Restaurants
            ...
            SizedBox(
              height: 180,
              child: restaurant.restaurantsList != null ? restaurant.restaurantsList.length > 0 ? ListView.builder(
                physics: BouncingScrollPhysics(),
                scrollDirection: Axis.horizontal,
                padding: EdgeInsets.only(left: Dimensions.PADDING_SIZE_SMALL),
                itemCount: restaurant.restaurantsList.length > 5 ? 5 : restaurant.restaurantsList.length,
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        */
                        //print(Provider.of<AuthProvider>(context, listen: false).getUserToken());

                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => RestaurantScreen(restaurant:restaurant.restaurantsList[index]),
                          ),
                        );
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: FadeInImage.assetNetwork(
                                  ...
                                  image: '${restaurant.restaurantsList[index].imageURL}',
                                  height: 110, width: 170, fit: BoxFit.cover,
                                ),
                              ),
                              restaurant.restaurantsList[index].available ? SizedBox() : Positioned(
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                Text(
                                  restaurant.restaurantsList[index].name,
                                ...
                                RatingBar(
                                  rating: 0.0,///restaurant.restaurantsList[index].rating.length > 0 ? double.parse(restaurant.restaurantsList[index].rating[0].average) : 0.0,
                                  size: 12,
                                ),
                                SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
