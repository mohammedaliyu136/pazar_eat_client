...
class CartScreen extends StatelessWidget {
  CartScreen({this.from_restaurant_page=false});
  bool from_restaurant_page;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: CustomAppBar(title: getTranslated('my_cart', context), isBackButtonExist: !from_restaurant_page?!ResponsiveHelper.isMobile(context):true),
