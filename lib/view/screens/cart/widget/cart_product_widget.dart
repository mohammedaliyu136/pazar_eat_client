                  ...
                  Row(children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        SizedBox(height: 2),
                        RatingBar(rating: cart.product.rating, size: 12),
                        SizedBox(height: 5),
                        Row(children: [
                          Flexible(
                            child: Text(
                              PriceConverter.convertPrice(context, cart.discountedPrice),
                              style: rubikBold.copyWith(fontFamily: 'RobotoMono',),
                            ),
                          ),
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: Row(children: [
                            ...
                            SizedBox(width: 2),
                            Text(PriceConverter.convertPrice(context, addOns[index].price), style: rubikMedium.copyWith(fontFamily: 'RobotoMono',)),
                            SizedBox(width: 2),
