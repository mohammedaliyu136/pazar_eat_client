                      ...
                      children: [
                        ...
                        CustomStepper(
                          ...
                          child: _status == _statusList[3] ? TrackingMapWidget(
                            ...
                            orderID: orderID,
                            addressModel: Provider.of<LocationProvider>(context).addressList!= null ? Provider.of<LocationProvider>(context).addressList.where((address) => address.id == order.trackModel.userId).first : null,
                          ) : null,
                          */
                        ),
