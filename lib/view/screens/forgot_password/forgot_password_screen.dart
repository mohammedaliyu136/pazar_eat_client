...
import 'success_password_reset.dart';
                            ...
                            !auth.isForgotPasswordLoading ? CustomButton(
                              ...
                              onTap: () {
                                if (_emailController.text.isEmpty) {
                                  ...
                                  Provider.of<AuthProvider>(context, listen: false).passwordReset(_emailController.text).then((value) {
                                    if (value.isSuccess) {
                                      //Navigator.pushNamed(context, Routes.getVerifyRoute('forget-password', _emailController.text));

                                      Navigator.pushAndRemoveUntil(
                                        context,
                                        MaterialPageRoute(builder: (BuildContext context) => SuccessPasswordResetScreen(emailAddress: _emailController.text,)),
                                        ModalRoute.withName('/'),
                                      );
                                    } else {
