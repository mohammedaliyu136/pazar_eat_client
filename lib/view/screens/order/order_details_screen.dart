    ...
    return Scaffold(
      ...
      body: Consumer<OrderProvider>(
        builder: (context, order, child) {
          ...
          double _itemsPrice = widget.orderModel.products.fold(0, (previousValue, element) => previousValue+=element.quantity*element.price);
          double _discount = 0;
          double _tax = 0;
          double _addOns = widget.orderModel.products.fold(0, (previousValue, element) => previousValue+=element.addOn.fold(0, (previousValue, element) => previousValue+element.price));

          /*
          if(order.orderDetails != null) {
            if(order.trackModel.orderType == 'delivery') {
              deliveryCharge = 0;//order.trackModel.deliveryCharge;
            }
            ...
            children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(children: [
                              ...
                              Text(widget.orderModel.id, style: rubikMedium),
                              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              Expanded(child: SizedBox()),
                              Icon(Icons.watch_later, size: 17),
                              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              Text(DateConverter.isoStringToLocalDateOnly(widget.orderModel.createdAt.toDate().toIso8601String()), style: rubikRegular),
                            ]),
                            ...
                            Row(children: [
                              ...
                              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              Text(widget.orderModel.foodItemsCount.toString(), style: rubikMedium.copyWith(color: Theme.of(context).primaryColor)),
                              Expanded(child: SizedBox()),
                              widget.orderModel.orderType == 'delivery' ? TextButton.icon(
                                onPressed: () {
                                  AddressModel _address;
                                  for(AddressModel address in Provider.of<LocationProvider>(context, listen: false).addressList) {
                                    if(false){//address.id == order.trackModel.deliveryAddressId) {
                                      _address = address;
                                      break;
                                    }
                                  }
                                  if(_address != null) {
                                    Navigator.pushNamed(context, Routes.getMapRoute(
                                      ...
                                      _address.contactPersonNumber, _address.id, 1,
                                    ));
                                  }
                                },
                              ...
                              Expanded(flex: 8, child: Row(children: [
                                Text(
                                  (widget.orderModel.paymentMethod != null && widget.orderModel.paymentMethod.length > 0)
                                      ? widget.orderModel.paymentMethod == 'cash_on_delivery' ? getTranslated('cash_on_delivery', context)
                                ...
                                (widget.orderModel.paymentStatus != 'paid' && widget.orderModel.paymentMethod != 'cash_on_delivery'
                                    && widget.orderModel.orderStatus != 'delivered') ? InkWell(
                                  onTap: () {
                                    showDialog(context: context, barrierDismissible: false, builder: (context) => ChangeMethodDialog(
                                      orderID: widget.orderModel.id.toString(), callback: (String message, bool isSuccess) {
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                widget.orderModel.products[index].addOn.forEach((addOn) {
                                  _addOns.add(addOn);
                                  /*
                                        ...
                                        Row(children: [
                                          ClipRRect(
                                            ...
                                            child: FadeInImage.assetNetwork(
                                              ...
                                              image: '${widget.orderModel.products[index].image}',
                                              height: 70,
                                              width: 80,
                                              fit: BoxFit.cover,
                                            ),
                                            ...
                                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Text('quantity:', style: rubikRegular),
                                                  Text(widget.orderModel.products[index].quantity.toString(), style: rubikMedium.copyWith(color: Theme.of(context).primaryColor)),
                                                ],
                                              ),
                                              SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                              Row(children: [
                                                Text(
                                                  PriceConverter.convertPrice(context, 100),
                                                  style: rubikBold.copyWith(
                                                    fontFamily: 'RobotoMono',
                                                  ),
                                                ),
                                                SizedBox(width: 5),
                                                  10 > 0 ? Expanded(child: Text(
                                                  PriceConverter.convertPrice(context, widget.orderModel.products[index].price),
                                                  style: rubikBold.copyWith(
                                              ...
                                              Row(children: [
                                                ...
                                                Text(
                                                  '${getTranslated(widget.orderModel.orderStatus == 'delivered' ? 'delivered_at' : 'ordered_at', context)} '
                                                      '${DateConverter.isoStringToLocalDateOnly(widget.orderModel.orderStatus == 'delivered'
                                                      ? widget.orderModel.createdAt.toDate().toIso8601String()
                                                      : widget.orderModel.createdAt.toDate().toIso8601String())}',
                                            ...
                                            itemBuilder: (context, i) {
                                              return Padding(
                                                ...
                                                child: Row(children: [
                                                  ...
                                                  SizedBox(width: 2),
                                                  Text(PriceConverter.convertPrice(context, _addOns[i].price), style: rubikMedium.copyWith(fontFamily: 'RobotoMono',)),
                                                  SizedBox(width: 2),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text(PriceConverter.convertPrice(context, _itemsPrice), style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, fontFamily: 'RobotoMono',)),
                            ]),
                            SizedBox(height: 10),
                            ...
                            */
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text('(+) ${PriceConverter.convertPrice(context, _addOns)}', style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, fontFamily: 'RobotoMono',)),
                            ]),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text(PriceConverter.convertPrice(context, _subTotal), style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, fontFamily: 'RobotoMono',)),
                            ]),
                            SizedBox(height: 10),

                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Text(getTranslated('discount', context), style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                              Text('(-) ${PriceConverter.convertPrice(context, _discount)}', style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, fontFamily: 'RobotoMono',)),
                            ]),
                            SizedBox(height: 10),
                            ...
                            */
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text('(+) ${PriceConverter.convertPrice(context, deliveryCharge)}', style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, fontFamily: 'RobotoMono',)),
                            ]),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text(
                                ...
                                style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE, color: Theme.of(context).primaryColor, fontFamily: 'RobotoMono',),
                              ),
                            ]),
              ...
              !order.showCancelled ? Center(
                child: SizedBox(
                  width: 1170,
                  child: Row(children: [
                    widget.orderModel.orderStatus == 'pending' ? Expanded(child: Padding(
                      padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                      child: TextButton(
                        style: TextButton.styleFrom(
                    ...
                    (widget.orderModel.paymentStatus == 'unpaid' && widget.orderModel.paymentMethod != 'cash_on_delivery' && widget.orderModel.orderStatus
                      ...
                      child: CustomButton(
                        ...
                        onTap: () async {
                          if(ResponsiveHelper.isWeb()) {
                            ...
                            String selectedUrl = '${AppConstants.BASE_URL}/payment-mobile?order_id=${widget.orderModel.id}&&customer_id=${Provider.of<ProfileProvider>(context, listen: false).userInfoModel.id}'
                                '&&callback=http://$hostname${Routes.ORDER_SUCCESS_SCREEN}/${widget.orderModel.id}';
                            html.window.open(selectedUrl, "_self");
                          }else {
                            Navigator.pushReplacementNamed(context, Routes.getPaymentRoute('order', widget.orderModel.id.toString(), widget.orderModel.userId));
                          }
                        },
                      ),
                    )) : SizedBox(),
              ...
              (widget.orderModel.orderStatus == 'confirmed' || widget.orderModel.orderStatus == 'processing'
                  || widget.orderModel.orderStatus == 'out_for_delivery') ? Center(
                    child: Container(
                width: 1170,
                padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                child: CustomButton(
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, Routes.getOrderTrackingRoute(widget.orderModel.id));
                    },
                ),
              ),
                  ) : SizedBox(),
