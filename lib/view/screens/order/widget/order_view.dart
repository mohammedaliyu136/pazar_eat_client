                              ...
                              Expanded(
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  Row(children: [
                                    ...
                                    Text(orderList[index].id.substring(0,4), style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL)),
                                    SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                  ...
                                  Text(
                                    '${orderList[index].foodItemsCount} ${getTranslated( orderList[index].foodItemsCount > 1 ? 'items' : 'item', context)}',
