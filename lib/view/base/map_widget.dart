...
class _MapWidgetState extends State<MapWidget> {
  ...
  //  final address = Provider.of<SplashProvider>(context).;
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)?PreferredSize(child: MainAppBar(), preferredSize: Size.fromHeight(80)): CustomAppBar(title: getTranslated('delivery_address', context)),
      body: Center(
        child: Container(
          width: 1170,
