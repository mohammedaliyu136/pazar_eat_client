  ...
  Future<http.StreamedResponse> updateProfile(UserInfoModel userInfoModel, String password, File file, PickedFile data, String token) async {
    ...
    if(password.isEmpty) {
      _fields.addAll(<String, String>{
        '_method': 'put', 'f_name': userInfoModel.fullName, 'phone': userInfoModel.phone
      });
    }else {
      _fields.addAll(<String, String>{
        '_method': 'put', 'f_name': userInfoModel.fullName, 'phone': userInfoModel.phone, 'password': password
      });
    }
