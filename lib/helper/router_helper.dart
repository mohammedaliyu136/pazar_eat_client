...
//*******Handlers*********
  ...
  static Handler _paymentHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) {
        return PaymentScreen(
          ...
          userId: params['user'][0], id: params['id'][0],
        ),
        );
      }
  );
  ...
  static Handler _orderDetailsHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) {
        ...
        return _orderDetailsScreen != null ? _orderDetailsScreen : OrderDetailsScreen(orderId: params['id'][0], orderModel: null);
      }
  );
  ...
  static Handler _mapHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) {
    return MapWidget(address: AddressModel(
      id: params['id'][0], userId: params['user'][0], contactPersonName: params['name'][0], contactPersonNumber: params['num'][0],
