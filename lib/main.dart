...
Future<void> main() async {
  ...
  try {
    if (!kIsWeb) {
      ...
      if (notificationAppLaunchDetails?.didNotificationLaunchApp ?? false) {
        _orderID = notificationAppLaunchDetails.payload != null ? notificationAppLaunchDetails.payload : null;
      }
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => di.sl<RestaurantsProvider>()),
    ],
