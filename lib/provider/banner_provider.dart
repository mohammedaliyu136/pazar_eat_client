...
class BannerProvider extends ChangeNotifier {
    ...
    if(bannerList == null || reload) {
      ...
      if (apiResponse.response != null && apiResponse.response.statusCode == 200) {
        ...
        apiResponse.response.data.forEach((category) {
          ...
          if(bannerModel.foodItemId != null) {
            getProductDetails(context, bannerModel.foodItemId.toString());
          }
  ...
  void getProductDetails(BuildContext context, String productID) async {
    ...
    if (apiResponse.response != null && apiResponse.response.statusCode == 200) {
      _productList.add(Product.fromJson(json: apiResponse.response.data));
    } else {
